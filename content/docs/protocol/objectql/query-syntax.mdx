...
<Callout type="warn">
`created_at` / `updated_at` are `datetime` (UTC instants), not calendar days. A
`$between: ['2024-01-01', '2024-12-31']` against a `datetime` column stops at
`2024-12-31T00:00:00.000Z` and therefore excludes almost all of December 31 — use
`{ $gte: '2024-01-01', $lt: '2025-01-01' }` instead.
</Callout>
