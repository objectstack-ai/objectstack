...
Use a [curated view](/docs/guides/solutions/field-grouping-and-order) (selected fields, progressive disclosure) rather than granting read on the raw object and dropping users onto a 40-column grid.
...
- [Who can see data / automation / interface](/docs/guides/solutions/data-automation-interface-access).
- Guide: [Security](/docs/guides/security); reference: [App schema](/docs/references/ui/app), [Permission schema](/docs/references/security/permission).
