...
| **[Build Progress](/docs/references/ai/build-progress)** | `build-progress.zod.ts` | BuildProgressPhase, BuildProgressFrame | Phases the agent loop streams while building and verifying |
...
## Shared Protocol (5 of 10 schemas)
