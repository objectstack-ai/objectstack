...
because the flag is not one concept: it is a single boolean read at **111
...
The largest single consumer — **17 of the 111 sites**.
...
- **Shipped semantics.** `isSystem` is a published contract with 111 read sites
...
| Of those reads: reads of `ExecutionContext.isSystem` | **111** | ✅ |
| — behaviour-bearing (rows 1–63 above) | 107 | ✅ |
...
| — the distinct symbols those reads live in — what this page anchors | 92 | ✅ |
