...
| 127 of 175 statically decidable, 48 runtime-parameter-name sites | restated on the `isSystem`-scoping card | **153 of 227** decidable, **74** undecidable |
...
| …whose object name is statically decidable | 153 |
| …whose object name is chosen at run time | 74 |
| …against an object with tenancy ENABLED | 152 |
...
Measured on 2026-09-22 at `496d65dc7`.
