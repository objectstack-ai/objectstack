...
- Object: [`examples/app-showcase/src/data/objects/inquiry.object.ts`](https://github.com/objectstack-ai/objectstack/blob/main/examples/app-showcase/src/data/objects/inquiry.object.ts).
- Public form: [`examples/app-showcase/src/ui/views/inquiry.view.ts`](https://github.com/objectstack-ai/objectstack/blob/main/examples/app-showcase/src/ui/views/inquiry.view.ts).
