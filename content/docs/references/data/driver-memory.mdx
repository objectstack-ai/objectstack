...
```typescript
import { AutoPersistenceConfig, FilePersistenceConfig, LocalStoragePersistenceConfig, PersistenceType } from '@objectstack/spec/data';
...
// Validate data
const result = AutoPersistenceConfig.parse(data);
```
