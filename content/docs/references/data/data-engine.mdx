...
| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **$filter** | `string \| any[] \| Record<string, any> \| any \| null` | optional | Transport spelling of `where` (OData `$filter`) |
| **filters** | `string \| any[] \| Record<string, any> \| any \| null` | optional | Transport spelling of `where` (plural of `filter`) |
| **$top** | `number \| string \| null` | optional | Transport spelling of `limit` (OData `$top`) |
| **$skip** | `number \| string \| null` | optional | Transport spelling of `offset` (OData `$skip`) |
| **$orderby** | `string \| string[] \| Record<string, Enum<'asc' \| 'desc'>> \| Record<string, 1 \| -1> \| { field: string; order: Enum<'asc' \| 'desc'> }[] \| null` | optional | Transport spelling of `orderBy` (OData `$orderby`) |
...
| **$count** | `boolean \| string \| null` | optional | Transport spelling of the response total-count flag (OData `$count`) |
| **filter** | `string \| any[] \| Record<string, any> \| any \| null` | optional | Transport spelling of `where` |
| **select** | `string \| string[] \| null` | optional | Transport spelling of `fields` |
| **sort** | `string \| string[] \| Record<string, Enum<'asc' \| 'desc'>> \| Record<string, 1 \| -1> \| { field: string; order: Enum<'asc' \| 'desc'> }[] \| null` | optional | Transport spelling of `orderBy` |
...
### Nested Shape: `QueryWithTransport.search`
...
### Nested Shape: `QueryWithTransport.aggregations[number]`
...
### Nested Shape: `QueryWithTransport.groupBy[number]`
...
### Nested Shape: `QueryWithTransport.expand[string]`
