...
Transport spellings of the QueryAST slots — folded to canonical keys at the boundary

### Properties

| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **$filter** | `string \| Record<string, any> \| any` | optional | Transport spelling of `where` (OData `$filter`) |
| **filters** | `string \| Record<string, any> \| any` | optional | Transport spelling of `where` (plural of `filter`) |
| **$top** | `number \| string` | optional | Transport spelling of `limit` (OData `$top`) |
| **$skip** | `number \| string` | optional | Transport spelling of `offset` (OData `$skip`) |
| **$orderby** | `string \| string[] \| Record<string, Enum<'asc' \| 'desc'>> \| Record<string, 1 \| -1> \| { field: string; order: Enum<'asc' \| 'desc'> }[]` | optional | Transport spelling of `orderBy` (OData `$orderby`) |
| **$select** | `string \| string[]` | optional | Transport spelling of `fields` (OData `$select`) |
| **$expand** | `string \| string[] \| Record<string, { object: string; fields?: string[]; where?: any; search?: string \| object; … }>` | optional | Transport spelling of `expand` (OData `$expand`) |
| **$search** | `string \| { query: string; fields?: string[]; fuzzy: boolean; operator: Enum<'and' \| 'or'>; … }` | optional | Transport spelling of `search` (OData `$search`) |
| **$searchFields** | `string \| string[]` | optional | Transport spelling of `searchFields` (OData `$searchFields`) |
| **$count** | `boolean \| string` | optional | Transport spelling of the response total-count flag (OData `$count`) |

### Nested Shape: `QueryTransportParams.$expand[string]`
...
### Nested Shape: `QueryTransportParams.$search`
...
Reference: { object: string; fields?: string[]; where?: any; search?: string | object; … }
