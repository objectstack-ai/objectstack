...
import type { TursoConfig } from '@objectstack/spec/data';
...
| :--- | :--- | :--- | :--- |
| **url** | `string` | ✅ | libSQL endpoint or local file (libsql://…, https://…, file:…, :memory:) |
...
| **syncUrl** | `string` | optional | Remote sync URL for embedded-replica mode (libsql:// or https://) |
