...
<Callout type="info">
**Source:** `packages/spec/src/marketplace/template-manifest.zod.ts`
</Callout>

## TypeScript Usage

```typescript
import { TemplateManifestSchema } from '@objectstack/spec/marketplace';
import type { TemplateManifest } from '@objectstack/spec/marketplace';
