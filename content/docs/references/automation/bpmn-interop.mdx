...
```typescript
import { BpmnDiagnosticSchema, BpmnElementMappingSchema, BpmnExportOptionsSchema, BpmnImportOptionsSchema, BpmnInteropResultSchema, BpmnUnmappedStrategySchema, BpmnVersionSchema } from '@objectstack/spec/automation';
...
// Validate data
const result = BpmnDiagnosticSchema.parse(data);
```
...
### Nested Shape: `BpmnExportOptions.customMappings[number]`
...
### Nested Shape: `BpmnImportOptions.customMappings[number]`
...
### Nested Shape: `BpmnInteropResult.diagnostics[number]`
