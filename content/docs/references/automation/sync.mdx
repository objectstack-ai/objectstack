...
```typescript
import { DataSourceConfig, SyncDirection, SyncExecutionResult, SyncExecutionStatus, SyncMode } from '@objectstack/spec/automation';
...
// Validate data
const result = DataSourceConfig.parse(data);
```
