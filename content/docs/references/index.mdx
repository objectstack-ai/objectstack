...
description: Every schema published by @objectstack/spec — 1529 schemas across 14 protocol modules
---
...
| **Total** | **194** | **1529** | 14 protocol modules |
...
**Source:** `packages/spec/src/system/` · **Import:** `@objectstack/spec/system` · **33 pages, 272 schemas**
