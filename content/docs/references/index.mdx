...
description: Every schema published by @objectstack/spec — 1520 schemas across 14 protocol modules
---
...
| [Shared Protocol](/docs/references/shared) | 9 | 29 | Primitives used across every protocol — identifiers, HTTP, expressions, error maps, enums. |
...
| **Total** | **191** | **1520** | 14 protocol modules |
...
**Source:** `packages/spec/src/shared/` · **Import:** `@objectstack/spec/shared` · **9 pages, 29 schemas**
