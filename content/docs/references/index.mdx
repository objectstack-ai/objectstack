...
description: Every schema published by @objectstack/spec — 1600 schemas across 14 protocol modules
---
...
| [UI Protocol](/docs/references/ui) | 16 | 145 | Apps, pages, views, dashboards, reports, actions and themes — the ObjectUI layer. |
| **Total** | **200** | **1600** | 14 protocol modules |
...
**Source:** `packages/spec/src/ui/` · **Import:** `@objectstack/spec/ui` · **16 pages, 145 schemas**
