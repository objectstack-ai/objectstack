...
description: Every schema published by @objectstack/spec — 1532 schemas across 14 protocol modules
---
...
| [UI Protocol](/docs/references/ui) | 16 | 157 | Apps, pages, views, dashboards, reports, actions and themes — the ObjectUI layer. |
| **Total** | **195** | **1532** | 14 protocol modules |
...
**Source:** `packages/spec/src/ui/` · **Import:** `@objectstack/spec/ui` · **16 pages, 157 schemas**
