...
| [API Protocol](/docs/references/api) | 29 | 418 | REST contracts, endpoints, routing, realtime, batch, discovery. |
...
| **Total** | **199** | **1587** | 14 protocol modules |
...
**Source:** `packages/spec/src/api/` · **Import:** `@objectstack/spec/api` · **29 pages, 418 schemas**
