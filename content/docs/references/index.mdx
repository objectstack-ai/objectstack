...
description: Every schema published by @objectstack/spec — 1608 schemas across 14 protocol modules
---
...
| **Total** | **201** | **1608** | 14 protocol modules |
...
| [`discovery.zod.ts`](/docs/references/api/discovery) | `ApiRoutes`, `Discovery`, `DiscoveryEnvironment`, `RouteHealthEntry`, `RouteHealthReport`, `ServiceInfo`, `ServiceSelfInfo`, `ServiceStatus`, `WellKnownCapabilities` |
