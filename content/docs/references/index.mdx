...
| [Shared Protocol](/docs/references/shared) | 7 | 26 | Primitives used across every protocol — identifiers, HTTP, expressions, error maps, enums. |
...
**Source:** `packages/spec/src/shared/` · **Import:** `@objectstack/spec/shared` · **7 pages, 26 schemas**
...
**Source:** `packages/spec/src/system/` · **Import:** `@objectstack/spec/system` · **36 pages, 291 schemas**
