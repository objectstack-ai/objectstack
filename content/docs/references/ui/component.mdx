...
| **items** | `any[]` | optional | Static inline entries — read FIRST and bypasses the object query entirely (the renderer becomes a pass-through and the author owns the item shape) |
