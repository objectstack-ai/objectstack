...
import type { Action, ActionAi, ActionLocation, ActionParam, InlineAction } from '@objectstack/spec/ui';
...
| **options** | `{ label: string \| Record<string, string>; value: string; visibleWhen?: string \| { dialect: Enum<'cel' \| 'cron' \| 'template'>; source?: string; ast?: any; meta?: object } }[]` | optional |  |
