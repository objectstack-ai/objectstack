...
```typescript
import { DndConfigSchema, DragConstraintSchema, DragHandleSchema, DragItemSchema, DropEffectSchema, DropZoneSchema } from '@objectstack/spec/ui';
import type { DndConfig, DragConstraint, DragHandle, DragItem, DropEffect, DropZone } from '@objectstack/spec/ui';

// Validate data
const result = DndConfigSchema.parse(data);
```
