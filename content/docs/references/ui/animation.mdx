...
```typescript
import { AnimationTriggerSchema, ComponentAnimationSchema, EasingFunctionSchema, MotionConfigSchema, PageTransitionSchema, TransitionConfigSchema, TransitionPresetSchema } from '@objectstack/spec/ui';
...
// Validate data
const result = AnimationTriggerSchema.parse(data);
```
