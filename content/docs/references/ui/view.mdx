...
| :--- | :--- | :--- | :--- |
| **viewKind** | `'list'` | ✅ |  |
| **config** | `{ name?: string; label?: string \| Record<string, string>; type?: Enum<'grid' \| 'kanban' \| 'gallery' \| 'calendar' \| 'timeline' \| 'gantt' \| 'map' \| 'chart' \| 'tree'>; data?: object \| object \| object \| object; … }` | ✅ | List-family view configuration. |
