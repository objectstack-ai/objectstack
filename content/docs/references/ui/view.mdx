...
### Nested Shape: `ViewItem.protection`
...
| **columnState** | `{ order?: string[]; widths?: Record<string, number> }` | optional | Studio round-trip: per-user column order/widths (runtime-only state, written by the console grid — not authored). #9933 |

### Nested Shape: `ViewItemWire.config`
...
### Nested Shape: `ViewItemWire.protection`
...
### Nested Shape: `ViewItemWire.columnState`
