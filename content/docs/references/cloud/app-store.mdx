...
| **category** | `Enum<'crm' \| 'erp' \| 'hr' \| 'finance' \| 'project' \| 'collaboration' \| 'analytics' \| …>` | ✅ | Marketplace package category |
...
| **reason** | `Enum<'popular-in-category' \| 'similar-users' \| 'complements-installed' \| 'trending' \| …>` | ✅ |  |

### Nested Shape: `AppDiscoveryResponse.recommended[number]`
...
### Nested Shape: `AppDiscoveryResponse.trending[number]`
...
### Nested Shape: `AppDiscoveryResponse.newArrivals[number]`
...
### Nested Shape: `ListReviewsResponse.items[number]`
