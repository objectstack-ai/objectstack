...
```typescript
import { ConnectorInstanceAPIKeyAuthSchema, ConnectorInstanceAuthSchema, ConnectorInstanceBasicAuthSchema, ConnectorInstanceBearerAuthSchema, ConnectorInstanceNoAuthSchema } from '@objectstack/spec/integration';
import type { ConnectorInstanceAuth } from '@objectstack/spec/integration';

// Validate data
const result = ConnectorInstanceAPIKeyAuthSchema.parse(data);
```
