...
| **error** | `{ code: Enum<'VALIDATION_ERROR' \| 'INVALID_FIELD' \| 'MISSING_REQUIRED_FIELD' \| … +276 more>; message: string; category?: string; httpStatus?: integer; … }` | optional | Error details if success is false |
