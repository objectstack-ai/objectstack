...
| **query** | `{ object: string; fields?: string[]; where?: any; search?: string \| object; … } \| … +1 more` | optional | Structured query definition (filter, sort, select, pagination) — the canonical QueryAST or its transport spelling. |

### Nested Shape: `FindDataRequest.query[option 1]`
...
### Nested Shape: `FindDataRequest.query[option 2]`
