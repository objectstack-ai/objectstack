...
```typescript
import { ODataQueryAdapter, OperatorMapping, QueryAdapterConfig, QueryAdapterTarget, RestQueryAdapter } from '@objectstack/spec/api';
...
// Validate data
const result = ODataQueryAdapter.parse(data);
```
