...
| :--- | :--- | :--- | :--- |
| **code** | `Enum<'VALIDATION_ERROR' \| 'INVALID_FIELD' \| 'MISSING_REQUIRED_FIELD' \| 'INVALID_FORMAT' \| 'VALUE_TOO_LONG' \| 'VALUE_TOO_SHORT' \| 'VALUE_OUT_OF_RANGE' \| … +330 more>` | ✅ | Error code (e.g. VALIDATION_ERROR; StandardErrorCode ∪ the ledger the serving side registers — ERROR_CODE_LEDGER for framework packages) |
...
### Nested Shape: `BaseResponse.meta`
...
### Nested Shape: `BulkResponse.meta`
...
### Nested Shape: `DeleteResponse.meta`
...
### Nested Shape: `ListRecordResponse.meta`
...
### Nested Shape: `SingleRecordResponse.meta`
