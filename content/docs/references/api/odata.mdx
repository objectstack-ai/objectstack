...
### Nested Shape: `ODataConfig.metadata`
...
| **details** | `{ code: string; message: string; target?: string }[]` | optional | Error details |
| **innererror** | `Record<string, any>` | optional | Inner error details |
...
### Nested Shape: `ODataMetadata.entityTypes[number]`

| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **name** | `string` | ✅ | Entity type name |
| **key** | `string[]` | ✅ | Key fields |
| **properties** | `{ name: string; type: string; nullable: boolean }[]` | ✅ |  |
| **navigationProperties** | `{ name: string; type: string; partner?: string }[]` | optional |  |

### Nested Shape: `ODataMetadata.entitySets[number]`

| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **name** | `string` | ✅ | Entity set name |
