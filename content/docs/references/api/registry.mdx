...
| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **apis** | `{ id: string; name: string; type: Enum<'rest' \| 'graphql' \| 'odata' \| 'websocket' \| 'file' \| 'auth' \| 'metadata' \| 'plugin' \| 'webhook' \| 'rpc'>; version: string; … }[]` | ✅ | Matching API entries |
| **total** | `integer` | ✅ | Total matching APIs |
| **filters** | `{ type?: Enum<'rest' \| 'graphql' \| 'odata' \| 'websocket' \| 'file' \| 'auth' \| 'metadata' \| 'plugin' \| 'webhook' \| 'rpc'>; tags?: string[]; status?: Enum<'active' \| 'deprecated' \| 'experimental' \| 'beta'>; pluginSource?: string; … }` | optional | Applied query filters |
...
| **apis** | `{ id: string; name: string; type: Enum<'rest' \| 'graphql' \| 'odata' \| 'websocket' \| 'file' \| 'auth' \| 'metadata' \| 'plugin' \| 'webhook' \| 'rpc'>; version: string; … }[]` | ✅ | All registered APIs |
| **totalApis** | `integer` | ✅ | Total number of registered APIs |
| **totalEndpoints** | `integer` | ✅ | Total number of endpoints |
| **byType** | `Record<string, { id: string; name: string; type: Enum<'rest' \| 'graphql' \| 'odata' \| 'websocket' \| 'file' \| 'auth' \| 'metadata' \| 'plugin' \| 'webhook' \| 'rpc'>; version: string; … }[]>` | optional | APIs grouped by protocol type |
| **byStatus** | `Record<string, { id: string; name: string; type: Enum<'rest' \| 'graphql' \| 'odata' \| 'websocket' \| 'file' \| 'auth' \| 'metadata' \| 'plugin' \| 'webhook' \| 'rpc'>; version: string; … }[]>` | optional | APIs grouped by status |
