...
| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **added** | `integer` | optional (default: `0`) | Number of added entities |
| **modified** | `integer` | optional (default: `0`) | Number of modified entities |
| **removed** | `integer` | optional (default: `0`) | Number of removed entities |
