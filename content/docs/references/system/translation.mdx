...
| **settings** | `Record<string, Object>` | optional | Settings manifest translations keyed by namespace |
| **metadataForms** | `Record<string, Object>` | optional | Translations for metadata-type configuration forms keyed by metadata type |
| **settingsCommon** | `Object` | optional | Cross-namespace Settings UI strings |
