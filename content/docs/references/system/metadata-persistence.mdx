...
| **loadTime** | `integer` | optional | How long the load took, in milliseconds |
...
| **etag** | `string` | optional |  |
| **size** | `number` | optional |  |
| **saveTime** | `integer` | optional | How long the save took, in milliseconds |
