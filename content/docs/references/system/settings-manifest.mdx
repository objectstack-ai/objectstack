...
| **specifiers** | `{ type: Enum<'group' \| 'child_pane' \| 'info_banner' \| 'title_value' \| 'text' \| 'textarea' \| …>; id?: string; key?: string; label: string \| Record<string, string>; … }[]` | ✅ | Page contents (ordered) |
...
### Nested Shape: `SettingsManifest.specifiers[number]`

| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **type** | `Enum<'group' \| 'child_pane' \| 'info_banner' \| 'title_value' \| 'text' \| 'textarea' \| …>` | ✅ | Specifier variant |
...
### Nested Shape: `SettingsNamespacePayload.values[string]`
...
### Nested Shape: `Specifier.options[number]`
...
### Nested Shape: `Specifier.handler[kind='http']`
...
### Nested Shape: `Specifier.handler[kind='action']`
...
### Nested Shape: `Specifier.handler[kind='navigate']`
