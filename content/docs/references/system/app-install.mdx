...
### Nested Shape: `AppCompatibilityCheck.issues[number]`

| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **severity** | `Enum<'error' \| 'warning'>` | ✅ | Issue severity |
| **message** | `string` | ✅ | Issue description |
| **category** | `Enum<'kernel_version' \| 'object_conflict' \| 'dependency_missing' \| 'quota_exceeded'>` | ✅ | Issue category |
