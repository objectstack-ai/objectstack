...
| **condition** | `{ threshold: integer; windowSeconds: integer; groupBy?: string[]; filters?: Record<string, any> } \| string \| { dialect: Enum<'cel' \| 'cron' \| 'template'>; source?: string; ast?: any; meta?: object }` | ✅ | Detection condition — structured threshold or CEL predicate |
