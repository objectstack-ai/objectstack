...
| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **maxRetries** | `integer` | optional (default: `3`) | Max retries for failed events |
| **backoffStrategy** | `Enum<'fixed' \| 'linear' \| 'exponential'>` | optional (default: `"exponential"`) | Backoff strategy |
| **initialDelayMs** | `integer` | optional (default: `1000`) | Initial retry delay |
| **maxDelayMs** | `integer` | optional (default: `60000`) | Maximum retry delay |
...
| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **type** | `Enum<'database' \| 'file' \| 's3' \| 'eventstore'>` | optional (default: `"database"`) | Storage backend |
| **options** | `Record<string, any>` | optional | Storage-specific options |
