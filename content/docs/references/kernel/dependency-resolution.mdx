...
```typescript
import { DependencyResolutionResultSchema, DependencyStatusEnum, RequiredActionSchema, ResolvedDependencySchema } from '@objectstack/spec/kernel';
import type { DependencyResolutionResult, RequiredAction, ResolvedDependency } from '@objectstack/spec/kernel';
...
### Nested Shape: `DependencyResolutionResult.dependencies[number]`
...
### Nested Shape: `DependencyResolutionResult.requiredActions[number]`
