...
```typescript
import { Event, EventMetadata, EventPriority, EventTypeDefinition } from '@objectstack/spec/kernel';
import type { Event, EventMetadata, EventPriority, EventTypeDefinition } from '@objectstack/spec/kernel';
