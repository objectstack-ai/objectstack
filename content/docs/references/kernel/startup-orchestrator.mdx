...
| Property | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **results** | `{ plugin: object; success: boolean; duration: number; error?: object; … }[]` | ✅ | Startup results for each plugin |
