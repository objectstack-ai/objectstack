...
| **cluster** | `Object` | optional | Cluster scope & leader strategy for this service. |
...
| **cluster** | `Object` | optional | Cluster scope & leader strategy. See cluster-semantics.mdx §5. |
