...
Error `code` values are SCREAMING_SNAKE (`VALIDATION_ERROR`, `PERMISSION_DENIED`, `RATE_LIMIT_EXCEEDED`, `RESOURCE_NOT_FOUND`) — see the [Error Catalog](/docs/api/error-catalog) for the full list.
</Callout>
