...
endpoint of your own. To publish your own URL as metadata, see [Declarative
Endpoints](/docs/api/declarative-endpoints).
...
- [Declarative Endpoints](/docs/api/declarative-endpoints) — declaring an endpoint of your own (`apis:`), the other half of this page's name
