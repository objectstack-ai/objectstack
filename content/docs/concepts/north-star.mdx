...
- **Open Core** - the runtime and protocols are Apache-2.0 licensed; hosted cloud features and official advanced Studio plugins may be proprietary
...
- **Compile-time-frozen seed timestamps.**
  [examples/app-crm/src/data/index.ts](examples/app-crm/src/data/index.ts) 的种子
