...
<Cards>
  <Card href="/docs/capabilities" title="I'm evaluating the platform" description="A business-language tour of what the platform can do — views, automation, approvals, permissions, analytics — no code required to read" />
