---
title: 17.0.0
description: "The v17 major cut, published 2026-08-14: files become owned sys_file records with a governed download path, bulk export becomes its own privilege, the SDK drops 21 methods no server answered, and a datasource that cannot connect fails the boot."
---
...
> The `17.0.0-rc.0` … `rc.6` train that preceded this cut is archived at
> **[17.0.0 pre-release train](/docs/releases/v17/17.0/prerelease)**.
