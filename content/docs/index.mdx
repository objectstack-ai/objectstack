...
- [What Can It Do?](/docs/capabilities) — the platform's capabilities in business language, no code — start here if you're evaluating
...
<Cards>
  ...
  <Card href="/docs/ui" title="Views & Apps" description="Apps, views, dashboards, and forms as server-driven UI (ObjectUI)" />
