...
same guarantee [validation predicates](/docs/data-modeling/validation#has-x-is-not-a-null-guard)
carry. A field this write didn't touch (and, for `record`, a field the driver
