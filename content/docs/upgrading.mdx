...
image: ghcr.io/objectstack-ai/objectstack:17.4.0
```
...
```bash
os migrate meta --from 16     # the major your metadata was authored against
```
...
The chain reaches back to **protocol 16** — that floor is a release-policy
