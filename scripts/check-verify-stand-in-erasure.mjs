...
function selfTest() {
  ...
  battery('CLEAN: the scan separates an asserted driver argument from a clean one.');
  ...
  battery('DISCOVERED: the shape test, on synthetic sources.');
  const synthetic = [
    {
      file: 'index.ts',
      text:
  ...
  battery('Wiring: discovery must reach the REAL tree, and reach the two helpers');
