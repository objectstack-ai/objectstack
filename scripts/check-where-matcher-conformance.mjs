...
const SELF_TEST_BATTERIES = Object.freeze({
  'the conjoining fixture — discovery and verdict': 16,
  '#8615: the captured-filter arm': 17,
  'the dispatch-gates declaration (#13163\'s landing obligation)': 6,
});
...
function selfTest() {
  ...
  battery('the conjoining fixture — discovery and verdict');
  ...
  // --- #8615: the captured-filter arm ------------------------------------
  battery('#8615: the captured-filter arm');
  ...
  battery('the dispatch-gates declaration (#13163\'s landing obligation)');
