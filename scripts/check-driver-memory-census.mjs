...
const SELF_TEST_BATTERIES = Object.freeze({
  'Binding positions, one per form.': 8,
  'MENTIONS: the distinction the whole census rests on. Each of these really': 6,
  'Two bindings in one file are reported separately (dev-plugin.ts really': 1,
  'Manifest scanning: dependency fields yes, `name` no.': 5,
  'Reconciliation, driven on synthetic scans so a real violation never': 14,
  'Wiring: discovery must reach the real tree and find the ruled files. NOT': 7,
});
...
function selfTest() {
  ...
  battery('Binding positions, one per form.');
  ...
  battery('MENTIONS: the distinction the whole census rests on. Each of these really');
  ...
  battery('Two bindings in one file are reported separately (dev-plugin.ts really');
  ...
  battery('Manifest scanning: dependency fields yes, `name` no.');
  ...
  battery('Reconciliation, driven on synthetic scans so a real violation never');
  ...
  battery('Wiring: discovery must reach the real tree and find the ruled files. NOT');
