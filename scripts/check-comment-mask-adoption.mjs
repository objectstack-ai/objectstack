...
const SELF_TEST_BATTERIES = Object.freeze({
  'Each SHAPE fires on the spelling measured in the tree': 8,
  'The ADOPTER must stay silent: this is the whole point': 3,
  'Prose must stay silent: the 18% fabrication this gate would otherwise': 3,
  'Negatives that must not fabricate': 5,
  'Ledger invariants': 3,
  'The instrument itself: the known-good probe MUST be recognised': 1,
});
...
export function selfTest() {
  ...
  battery('Each SHAPE fires on the spelling measured in the tree');
  ...
  battery('The ADOPTER must stay silent: this is the whole point');
  ...
  battery('Prose must stay silent: the 18% fabrication this gate would otherwise');
...
const m = maskComments(src);`) === '');
  ...
  battery('Negatives that must not fabricate');
  ...
  battery('The instrument itself: the known-good probe MUST be recognised');
