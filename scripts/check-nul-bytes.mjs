...
const SELF_TEST_BATTERIES = Object.freeze({
  '#6984: everything BELOW this line is deliberately left unstaged': 3,
  '#5157: the widening, proved in both directions': 10,
  '#5460: DEL added to the set, proved in both directions': 10,
  '#6984: the untracked half of the scan set, proved in both directions': 41,
  '#6984, the CI direction: on a fully tracked tree the widening is a no-op': 4,
  '#5646: the class is transcribed nowhere': 7,
});
...
function selfTest() {
  ...
  try {
    ...
    battery('#6984: everything BELOW this line is deliberately left unstaged');
    ...
    battery('#5157: the widening, proved in both directions');
    ...
    battery('#5460: DEL added to the set, proved in both directions');
    ...
    battery('#6984: the untracked half of the scan set, proved in both directions');
    assert(
  ...
  battery('#5646: the class is transcribed nowhere');
