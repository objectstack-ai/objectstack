...
Console (objectui) refreshed to `0fd11444a89e`. Frontend changes in this range:

Derived from the changesets objectui declared over the range — 108 releasing of 123 changesets added across 149 non-merge commits; omitted: 15 release-nothing changesets, 27 commits carrying no changeset (they ship no package code).
