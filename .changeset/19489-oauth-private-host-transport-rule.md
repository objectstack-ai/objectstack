...
- **One loud startup line** whenever OAuth is served over plain HTTP, and none under TLS: 「OAuth 未加密:仅限可信内网」, followed by the issuer URL and what crosses the wire in the clear.
