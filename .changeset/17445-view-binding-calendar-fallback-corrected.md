...
- **No severity moves.** Whether a renderer that refuses BY NAME still deserves WARNING under ADR-0078 §1 is #16577's question; correcting false prose does not answer it, and nothing here pre-empts it.
