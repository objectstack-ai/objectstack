...
```dockerfile
FROM ghcr.io/objectstack-ai/objectstack:17.5.0
...
docker run -p 8080:8080 \
  ...
  ghcr.io/objectstack-ai/objectstack:17.5.0
```
...
```bash
docker build -t objectstack:dev --build-arg OS_CLI_VERSION=17.5.0 docker/
```
