...
- 写节奏 ⛔ 非可选:REST 写间隔 ≥3 秒、每账号每小时 ≤40 笔;429 ⇒ 该席本 fire 停写记贴。
...
- 零的三件判据、目录约定与精确名匹配见 `references/filing-gate.md` 的〈读数判据〉。
...
- 立卡门:只为四类立卡 —— 缺陷 / 维护者决定 / 直派任务 / 协调节点,⛔ 其余不立卡。
- 正文首行写类别字母;四类定义、⛔ 清单、三答与配额见 `references/filing-gate.md`。
