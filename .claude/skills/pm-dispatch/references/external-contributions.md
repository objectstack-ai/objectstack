...
- 该卡正文恒带行首 `Adopts: #M`(M = fork PR 号),立卡或挂接那一笔写;收口与补关只认这一行。
...
- 关卡那一笔同时关 `Adopts:` 所指 fork PR,⛔ 不拆到事后:completed 附致谢与落地链接。
- not_planned 附致谢与谢绝理由;除 ① 的固定评论,席位在 fork PR 上只写 review 与关闭评论。
