...
/**
 * Recorded source hashes for `ja-JP` (#8765, Option B).
 *
 * Each entry is the digest of the `en.ts` SOURCE STRING that the `ja-JP`
 ...
 *
 * **Re-translated a string?** Update the value in `ja-JP.ts` AND the digest
 ...
 */
export const jaJPSourceHashes: Readonly<Record<string, string>> = {
