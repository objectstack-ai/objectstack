...
/**
 * Recorded source hashes for `zh-CN` (#8765, Option B).
 *
 * Each entry is the digest of the `en.ts` SOURCE STRING that the `zh-CN`
 ...
 *
 * **Re-translated a string?** Update the value in `zh-CN.ts` AND the digest
 ...
 */
export const zhCNSourceHashes: Readonly<Record<string, string>> = {
