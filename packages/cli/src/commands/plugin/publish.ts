...
export default class PluginPublish extends Command {
  ...
  async run(): Promise<void> {
    ...
    // publishable). Unpack-time re-verification is owned by the future
    // runtime loader (ADR-0025 §3.5 steps 4–7), not by the cloud control
    // plane (#11331) — this preflight does not discharge it.
