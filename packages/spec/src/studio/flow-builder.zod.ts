...
export const BUILT_IN_NODE_DESCRIPTORS: FlowNodeRenderDescriptor[] = [
  ...
  { action: 'http', shape: 'rounded_rect', icon: 'globe', defaultLabel: 'HTTP Request', defaultWidth: 120, defaultHeight: 60, fillColor: '#ffffff', borderColor: '#94a3b8', allowBoundaryEvents: true, paletteCategory: 'activity' },
