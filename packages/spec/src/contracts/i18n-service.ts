...
export interface II18nService {
     ...
     * constructed WITH it — `FileI18nAdapter`, which `os serve` and the dev
     * plugin hand `fallbackLocale || defaultLocale || 'en'` — omits this
     * method and keeps the value it was built with.
     *
