  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        // Text field options
        // #11949 — `minLength` converges on the same ten bounded-string types
        // as `maxLength` below (BOUNDED_STRING_FIELD_TYPES; maintainer ruling
        ...
        // type and the validator enforced it on 10.
        { field: 'minLength', visibleWhen: "data.type in ['text','textarea','email','url','phone','password','markdown','html','richtext','code']", helpText: 'Minimum character length' },
