...
const step17: MigrationStep = {
  ...
  rationale:
    ...
    + 'The last protocol-17 retirement needs NO source edit at all, and that is what makes it '
    + 'worth reading (#4988, ADR-0049): the five `@objectstack/spec/ui` interaction-config '
