 ...
 * covered — and the `MetadataPluginConfig.additionalTypes` retirement (#8586,
 * ADR-0049): the inert plugin kind-declaration key, tombstoned on the 17.x
 * line, with no D2 conversion because a plugin config is not a stack
 * collection member (the `kernel/Manifest:loading` precedent).
 */
