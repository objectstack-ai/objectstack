...
export const entry: SemanticMigration = {
  ...
  surface:
    ...
    + '({ dialect: \'cel\', source: \'   \' }) or the bare-string shorthand for it. The published '
  ...
  acceptanceCriteria:
    ...
    + '`ServiceLevelIndicator.successCriteria`, `TraceSamplingConfig.composite[].condition`) where '
    + 'the boolean or object arm is untouched. For each hit: if it carries an `ast`, run '
