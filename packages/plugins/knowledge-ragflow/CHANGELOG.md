...
- cb005e0: The RAGFlow adapter now reads the declared key: a source's RAGFlow binding comes from `adapterConfig.datasetId`, not `options.datasetId`.
...
- Updated dependencies [8fd246d]
  ...
  - @objectstack/service-knowledge@17.4.0
