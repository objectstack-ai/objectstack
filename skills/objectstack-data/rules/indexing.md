...
> **Retired at protocol 18 (#5248, #4943): `type` and `partial`.** Both were
...
> `os migrate meta --from 17` to strip them automatically. What to do instead
...
retired at protocol 18 (#5248, #4943) precisely because nothing consumed them.
